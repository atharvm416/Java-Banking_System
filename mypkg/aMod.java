...
import mypkg.Util;
public class aMod extends JDialog implements ActionListener,FocusListener
{
	JLabel l1,l2,l3,l4;
	...
	int no,opn;
	String nm;
	public aMod(JFrame frm, String title,boolean state)
	{
	...
	public void focusLost(FocusEvent e)
	{
		...
		else
		{
			try
			{
				opn=Integer.parseInt(t3.getText());
			}
			catch(Exception e1)
			{
				t3.requestFocus();
